...
**Figure 6File for Final Paper 14.33 Fall 2020
...
*Figure 6a (edit the graphs manually to include axis labels and titles)

line ita_death_week kor_death_week irn_death_week jpn_death_week usa_death_week day


*Figure 6b (edit the graphs manually to include axis labels and titles)

line gbr_death_week rus_death_week fra_death_week ind_death_week per_death_week day


*Figure 6c (edit the graphs manually to include axis labels and titles)
