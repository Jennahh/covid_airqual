...
**Figures 1-3 File for Final Paper 14.33 Fall 2020
...
*Figure 1 (edit the graphs manually to include axis labels and titles)

line ita_lckdwn kor_lckdwn irn_lckdwn jpn_lckdwn usa_lckdwn day


*Figure 2 (edit the graphs manually to include axis labels and titles)

line gbr_lckdwn rus_lckdwn fra_lckdwn ind_lckdwn per_lckdwn day


*Figure 3 (edit the graphs manually to include axis labels and titles)
